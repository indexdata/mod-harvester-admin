...
<xsl:stylesheet
    ...
    <xsl:template match="//oai20:header[@status='deleted']">
        <delete>
            <oaiIdentifier>
                <xsl:value-of select="oai20:identifier"/>
            </oaiIdentifier>
            ...
            <xsl:if test="marc:datafield[@tag='010' or @tag='020' or @tag='022' or @tag='024' or @tag='028' or @tag='035' or @tag='074']
                ...
                <identifiers>
                    <arr>
                        ...
                        <xsl:for-each
                                select="marc:datafield[(@tag='001' or @tag='010' or @tag='020' or @tag='022' or @tag='024' or @tag='028' or @tag='035' or @tag='074') and normalize-space(./marc:subfield[@code='a'])]">
                            <i>
                                <xsl:choose>
                                    ...
                                    <xsl:when test="current()[@tag='074'] and marc:subfield[@code='a']">
                                        ...
                                        <identifierTypeId>351ebc1c-3aae-4825-8765-c6d50dbf011f
                                        </identifierTypeId> <!-- GPO item number -->
                                    </xsl:when>
                                </xsl:choose>
                            </i>
                        </xsl:for-each>
                            ...
                            <i>
                                <xsl:choose>
                                    ...
                                    <xsl:when test="current()[@tag='082']">
                                        ...
                                        </classificationTypeId> <!-- Dewey -->
                                    </xsl:when>
                                    <xsl:when test="current()[@tag='086']">
                                        <classificationNumber>
                                            <xsl:value-of select="marc:subfield[@code='a']"/>
                                        </classificationNumber>
                                        <classificationTypeId>9075b5f8-7d97-49e1-a431-73fdd468d476
                                        </classificationTypeId> <!-- SUDOC -->
                                    </xsl:when>
                                </xsl:choose>
                            </i>
                        </xsl:for-each>
                    ...
                    <arr>
                        <xsl:for-each select="marc:datafield[@tag='500' or @tag='504' or @tag='505' or @tag='520']">
                            <i>
                                ...
                                <instanceNoteTypeId>
                                    <xsl:choose>
                                        <xsl:when test='./@tag="504"'>86b6e817-e1bc-42fb-bab0-70e7547de6c1
                                        </xsl:when> <!-- biliography -->
                                        <xsl:when test='./@tag="505"'>5ba8e385-0e27-462e-a571-ffa1fa34ea54
                                        </xsl:when> <!-- contents -->
                                        <xsl:when test='./@tag="520"'>0e2e11b-450f-45c8-b09b-0f819999966e
                                        </xsl:when> <!-- contents -->
                                        <xsl:otherwise>6a2533a7-4de2-4e64-8466-074c2fa9308c
                                        </xsl:otherwise> <!-- general -->
                                    </xsl:choose>
                                </instanceNoteTypeId>
                            </i>
                        </xsl:for-each>
