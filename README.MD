...
| Queryable fields | `name`, `message`, `currentStatus`, `amountHarvested`, `enabled`, `allowErrors` (etc)                                                                                                                                                                                                                                              | `harvestableId`, `name`, `type`, `transformation`, `storage`, `status`, `message` (more coming)                                                                                                                                                                                                                                                                                                                                                                    |
|                  |                                                                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Query syntax     | Queries not supported                                                                                                                                                                                                                                                                                                              | Exact: query=harvestableName=="My harvest job"<br/>Exact with masking: query=harvestableName=="\*harvest\*"<br/>Word search: query=harvestableName=harvest<br/>Failed records can be search by their time stamp using the time range parameters `from` and `until`: ?from=2023-04-12T23:59:59&until=2023-04-13T23:59:59                                                                                                                                            |
