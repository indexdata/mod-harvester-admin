...
| Queryable fields |                                                                                                                                                                                                                                                                                                                                    | `harvestableId`, `harvestableName`, `recordNumber`, `timeStamp` (separate query parameter). <br/>Note that since error reports can be quite large, the default `limit` for results is 100.                                                                                                                                                                                                                                                                         |
