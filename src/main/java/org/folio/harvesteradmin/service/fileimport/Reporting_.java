...
public class Reporting_ {
    ...
    public Reporting_ (ImportJob handler, String tenant, Vertx vertx) {
        this.jobConfigId = handler.jobConfigId();
        ...
        try {
            if (!fileStats.isEmpty()) {
                ...
                log("File #" + filesProcessed.get() + " (" + stats.getFileName() + ") "
                        ...
                        " recs/s.)").compose(na -> log(stats.getInventoryMetrics().report()));
